      ...
      <div className="max-w-[1200px] mx-auto px-4 md:py-16 py-8">
        <div className="grid lg:grid-cols-12 gap-8">
              ...
              {categories.map((category, index) => (
                <div key={index} className="border-b border-gray-800">
                  <button
                    ...
                    className={`w-full py-3 px-4 flex items-center justify-between transition-all text-[13px] ${
                      category.highlight 
                        ? "" 
          ...
          <div className="lg:col-span-4 flex flex-col justify-center items-center text-center bg-gradient-to-br from-orange-500/10 to-orange-600/5 rounded-2xl p-8 border border-orange-500/20">
            <div className="w-15 h-15 bg-orange-500 rounded-full flex items-center justify-center mb-6 shadow-lg shadow-orange-500/50">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-orange-500 rounded-lg flex items-center justify-center transition-all hover:scale-110">
